    ...
    def train_model(self, train_loader, val_loader, epochs=2000, lr=0.01, weight_decay=1e-5, 
        ...
        for epoch in range(epochs):
            ...
            if val_loss < best_val_loss:
                ...
                print(f"Saved best loss model checkpoint to models/ (val_loss: {val_loss:.4f})")
        
            # Also save the best model by validation accuracy
            if val_acc > best_val_acc:
                best_val_acc = val_acc
            
                # Save the best accuracy model to models directory
                ...
                print(f"Saved best accuracy model checkpoint to models/ (val_acc: {val_acc:.2f}%)")
